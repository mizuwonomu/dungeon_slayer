...
public class App extends Application{
    ...
    private void initializeEntities(){
        try {
            ...
            Image wallImg = new Image(getClass().getResourceAsStream("/assets/wall.png"), TILE_SIZE, TILE_SIZE, true, false);

            player = new Player(WIDTH / 2, HEIGHT / 2, iDown, iUp, iLeft, iRight, rDown, rUp, rLeft, rRight, 8, TILE_SIZE, TILE_SIZE);
